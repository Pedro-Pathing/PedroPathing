...
public class VectorCalculator {
    ...
    public VectorCalculator(FollowerConstants constants) {
        ...
        drivePIDF = this.controllerManager.createDrive(constants);
        translationalPIDF = this.controllerManager.createTranslational(constants);
        headingPIDF = this.controllerManager.createHeading(constants);

        updateConstants();
    }
    
    public void updateConstants() {
        controllerManager.updateCoefficients(constants);
