...
public class PolyDiffUtil {
     ...
     */
    private static java.util.Vector<ElementReference> generateMappings(int diffLevel, int elementCount){
     ...
     */
    private static java.util.Vector<ElementReference> generateMappings(int idxOffset, int diffLevel, int elementCount){
        { // check params
            if (elementCount < 0){
